    ...
    <div className="container px-4 py-10 text-black md:px-6 md:py-12 lg:py-16">
      ...
      <div className="flex flex-col gap-2 pb-4">
        <nav className="flex gap-1 text-sm text-gray-500">
          <Link href="/" className="hover:text-[#718355] transition-colors">Home</Link>
          <ChevronRight className="h-4 w-4" />
          <Link href="/shop" className="hover:text-[#718355] transition-colors">Shop</Link>
          <ChevronRight className="h-4 w-4" />
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-4">
            ...
            <div className="flex flex-col gap-2 sm:flex-row">
              <Button 
                className="bg-[#718355] hover:bg-[#87986A] flex-1" 
                size="lg" 
                onClick={() => addToCart({
                  name: product.name,
                  price: product.price,
      ...
      <div className="mt-12">
        <Tabs defaultValue="description">
          <TabsList className="w-full justify-start border-b">
            <TabsTrigger value="description" className="text-[#718355]">Description</TabsTrigger>
...
const products: Product[] = [
  {
    ...
    fullDescription: "This beautiful handcrafted wooden cross necklace serves as a meaningful reminder of your faith...",
...
const reviews: Review[] = [
  {
    ...
    text: "I purchased this as a gift for my daughter's confirmation...",
  },
  // ... other reviews
]
